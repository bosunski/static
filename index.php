...
<head>
    ...
    <title>Ticket Order History | eTicket</title>
            ...
            $('.dataTables-example').DataTable({
                ...
                initComplete: function () {
                    this.api().column(2).every( function () {
                        var column = this;
                        var select = $('<select class="input-sm form-control"><option value="">Location</option></select>')
                    ...
                    this.api().column(3).every( function () {
                        var column = this;
                        var select = $('<select class="input-sm form-control"><option value="">Stages</option></select>')
                            .appendTo( "#DataTables_Table_0_filter" )
                            .on( 'change', function () {
                                var val = $.fn.dataTable.util.escapeRegex(
                                    $(this).val()
